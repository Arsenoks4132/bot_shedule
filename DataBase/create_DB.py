...
cursor.execute(
    """CREATE DATABASE shedule_telegram_bot
    ENCODING 'UTF-8'
...
cursor.execute(
    '''
    INSERT INTO student (chat_id, group_name) VALUES('622603789', 'ИКБО-10-23')
    '''
)
conn.commit()
...
cursor.execute(
    '''
    INSERT INTO admin (student_id, rule_type) VALUES(1, 'main')
    '''
)
